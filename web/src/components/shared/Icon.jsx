...
// Professional line-icon set (single source of truth). 24x24 grid, stroke-based.
// Use: <Icon name="home" /> — swap-in replacement for the old emoji glyphs.
const PATHS = {
  home: <><path d="M3 9.5 12 3l9 6.5" /><path d="M5 9.5V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5" /><path d="M9 21v-6h6v6" /></>,
